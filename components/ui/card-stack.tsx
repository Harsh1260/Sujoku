                ...
                <div className="mt-8 flex items-center justify-center gap-3">
                    ...
                    {activeItem.href ? (
                        <Link
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex items-center justify-center h-10 w-10 rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition shadow-md"
...
function DefaultFanCard({ item }: { item: CardStackItem; active: boolean }) {
    return (
        <div className="group relative h-full w-full bg-card overflow-hidden">
            {/* image */}
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-8">
                <div className="inline-block px-3 py-1 bg-primary/90 text-primary-foreground text-xs font-semibold tracking-wider uppercase rounded-full w-max mb-3 backdrop-blur-md border border-white/20">
                    Therapy
                </div>
                <div className="truncate text-3xl font-light text-white mb-2 drop-shadow-md">
                    {item.title}
                </div>
                {item.description ? (
                    <div className="line-clamp-2 text-base font-light leading-relaxed text-white/90 drop-shadow-sm transition-all duration-300 group-hover:-translate-y-2">
                        {item.description}
                    </div>
                ) : null}
                ...
                {item.price && (
                    <div className="absolute bottom-6 right-8 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out flex items-center justify-center bg-white text-primary px-4 py-2 rounded-full font-semibold shadow-xl">
                        {item.price}
                    </div>
                )}
            </div>
